class TopicSummaryGeneration < ApplicationRecord
  ...
  has_many :requesting_users, through: :topic_summary_requests, source: :user
  ...
  validates :source_fingerprint, uniqueness: { scope: :topic_id }, allow_nil: true
  ...
  def source_message_ids_match_coverage
    return if source_message_ids.nil? && source_message_count.nil?
