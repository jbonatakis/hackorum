...
ActiveRecord::Schema[8.0].define(version: 2026_07_11_170000) do
  ...
  create_table "activities", force: :cascade do |t|
    ...
    t.index ["user_id", "subject_id"], name: "idx_activities_unique_ai_summary_ready", unique: true, where: "(((subject_type)::text = 'TopicSummary'::text) AND ((activity_type)::text = 'ai_summary_ready'::text))"
  ...
  create_table "topic_summaries", force: :cascade do |t|
    ...
    t.index ["topic_id", "source_fingerprint"], name: "index_topic_summaries_on_topic_id_and_source_fingerprint", unique: true
  ...
  create_table "topic_summary_generations", force: :cascade do |t|
    ...
    t.index ["topic_id", "source_fingerprint"], name: "idx_topic_summary_generations_source", unique: true, where: "(source_fingerprint IS NOT NULL)"
  ...
  create_table "topic_summary_requests", force: :cascade do |t|
    t.bigint "topic_summary_generation_id", null: false
    t.bigint "user_id", null: false
    t.string "request_kind", null: false
    t.datetime "quota_consumed_at"
    t.datetime "notified_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["topic_summary_generation_id", "user_id"], name: "idx_topic_summary_requests_unique", unique: true
    t.index ["topic_summary_generation_id"], name: "index_topic_summary_requests_on_topic_summary_generation_id"
    t.index ["user_id", "quota_consumed_at"], name: "index_topic_summary_requests_on_user_id_and_quota_consumed_at"
    t.index ["user_id"], name: "index_topic_summary_requests_on_user_id"
  end
  ...
  add_foreign_key "topic_summary_requests", "topic_summary_generations"
  add_foreign_key "topic_summary_requests", "users"
